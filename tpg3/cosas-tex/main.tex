...
\begin{Representacion}
    ...
    La estructura interna del módulo fichin es una tupla de elementos que representan a los observadores 
    
    del TAD fichin, además la tupla tambien cuenta con una matriz denominada tablero que es una representacion del 
